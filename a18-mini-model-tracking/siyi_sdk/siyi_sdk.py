...
try:
    ...
    # Fallback for direct script-style execution.
    from siyi_message import *
    from utils import toInt
    import cameras
...
class SIYISDK:
    ...
    def disconnect(self):
        ...
        with self._disconnect_lock:
            ...
            # Close socket first to unblock any recvfrom() call
            ...
            for thread_obj in (self._recv_thread, self._conn_thread, self._g_info_thread, self._g_att_thread):
                if thread_obj is None or thread_obj is current_thread:
                    continue
