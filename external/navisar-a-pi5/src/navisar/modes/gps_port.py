        ...
        if nmea_payload or ubx_payload:
            ...
            self.last_payload = {
                ...
                "nmea": {
                    ...
                    "utc_time": nmea_payload.get("utc_time") if nmea_payload else None,
                    "date_ddmmyy": nmea_payload.get("date_ddmmyy") if nmea_payload else None,
                    "lat_nmea": nmea_payload.get("lat_nmea") if nmea_payload else None,
                    "lat_dir": nmea_payload.get("lat_dir") if nmea_payload else None,
                    "lon_nmea": nmea_payload.get("lon_nmea") if nmea_payload else None,
                    "lon_dir": nmea_payload.get("lon_dir") if nmea_payload else None,
                    "fix_quality": nmea_payload.get("fix_quality") if nmea_payload else None,
                    "status": nmea_payload.get("status") if nmea_payload else None,
                    "hdop": nmea_payload.get("hdop") if nmea_payload else None,
                    "alt_m": nmea_payload.get("alt_m") if nmea_payload else None,
                    "alt_unit": nmea_payload.get("alt_unit") if nmea_payload else None,
                    "geoid_sep_m": nmea_payload.get("geoid_sep_m") if nmea_payload else None,
                    "geoid_sep_unit": nmea_payload.get("geoid_sep_unit") if nmea_payload else None,
                    "speed_knots": nmea_payload.get("speed_knots") if nmea_payload else None,
                    "course_field": nmea_payload.get("course_field") if nmea_payload else None,
                    "mode": nmea_payload.get("mode") if nmea_payload else None,
                    "gga_text": nmea_payload.get("gga_text") if nmea_payload else None,
                    "rmc_text": nmea_payload.get("rmc_text") if nmea_payload else None,
                },
                "ubx": {
