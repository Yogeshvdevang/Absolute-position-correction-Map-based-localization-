  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "live-indicator-foreground": "hsl(var(--live-indicator-foreground))",
        "blue-highlight": "hsl(var(--blue-highlight))",
        "green-highlight": "hsl(var(--green-highlight))",
        "orange-highlight": "hsl(var(--orange-highlight))",
        "red-highlight": "hsl(var(--red-highlight))",
        "gray-highlight": "hsl(var(--gray-highlight))",
      },
      borderRadius: {
        lg: "var(--radius)",
